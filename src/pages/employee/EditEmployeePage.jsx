...
import { EMPLOYEE_UPDATE_RESET } from '../../redux/constants/employeeConstants';
...
const EditEmployeePage = (props) => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(updateEmployee({ _id: user._id, name, email, is_staff }));
  };
